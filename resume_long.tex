...
\begin{document}
    ...
    \cvitem{}{
        ...
        \\
        Versed in building stacks from the ground up, leveraging the reliability and flexibility of open-source software and modern containerization to maximize reliability, security, reusability high uptime in connected multi-container systems.
        }
    ...
    \cventry{07/2025 -- Present}{Systems Engineer/Software Developer}{South-Asian Women's Rights Organization}{Toronto, Canada}{Client Management System}{
        \begin{itemize}
            ...
            \item Orchestrated a comprehensive redesign of the PHP and SQL-based CMS using Django and Python3 for the backend, complemented by React and Next.JS for routing on the frontend, thereby enhancing scalability and maintainability.
            \begin{itemize}
            ...
            \item Developed a RESTful API with the Django Rest Framework, facilitating seamless communication between the frontend and backend.
...
%\item Used Django Rest Framework to build REST API for communication between front-end and back-end.
    ...
    \cventry{04/2022-- 06/2025}{Full Stack Engineer}{TitanFile Inc}{Toronto, Canada}{}{
        ...
        \begin{itemize}
            ...
            \item Streamlined GitLab CI jobs as the DRI of DevOps, eliminating unnecessary or unchanged jobs, which
            accelerated testing pipelines by 10%.
            ...
            \item Resolved system outages caused by watermarking of large PDF files on the back-end, reducing downtime and memory usage by 10\% and allowing for error-free and more responsive PDF previewing of large files on the front-end.
        ...
        \begin{itemize}
            % {
                ...
                %\item Wrote Playwright and Jest tests for front-end code.
                %}
            %\textbf{General}
        \end{itemize}
    }
    ...
    \cventry{02/2021 -- 12/2021}{Systems Engineer/Software Developer}{Promatec Solutions}{Pretoria, South Africa}{}{
            ...
            \item Devised highly available, microservice-based container systems by implementing web service and email
...
\cventry{09/2016-- 04/2017}{Teaching Assistant}{University of Toronto}{Toronto, Canada}{Software Tools and Systems Programming}{
           \begin{itemize}
        \item Covered weekly lecture materials and aided students in debugging code assignments during labs of 20 - 30 people, improving students' knowledge of Linux system tool usage and debugger use in GDB and Valgrind to identify bugs in code.
...
\item Analyzed system logs from Android devices to debug code, identify and fix SELinux security policy issues and ensure fully functionality while maintaining compatibility and security between Android upgrades.
    \end{itemize}
            ...
            %\item Deployed Jenkins, then BuildKite, to automate builds on code submission in Gerrit and GitHub, automating .
...
\cvitem{Operating Systems}{Ubuntu/Debian-based systems, CentOS, MacOS, Android/AOSP-based systems}
