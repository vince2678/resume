...
\begin{document}
    ...
    \cventry{04/2022-- 06/2025}{Full Stack Engineer}{TitanFile Inc}{Toronto, Canada}{}{
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                development.
            \end{itemize}
            \item Created new React components and views as part of Admin Settings Console rewrite on the front-end, creating 90\% of views according to requirements within 3 months.
            \begin{itemize}
    ...
    \cventry{02/2021 -- 12/2021}{Systems Engineer/Software Developer}{Promatec Solutions}{Pretoria, South Africa}{}{
        \begin{itemize}
            ...
            %\item Devised highly available, micro-service based container system to provide email and React-based single-page application. solutions with AWS ECS.
    ...
    \section{Skills}
    \cvitem{Languages}{Python,TypeScript/JavaScript, SQL, Bash/Unix Shell, Makefile}
    ...
    \cvitem{Technologies}{Docker, React, Playwright, NextJS, Jest, Git, GitLab, Ansible, PostMan}
    \cvitem{Operating Systems}{Ubuntu/Debian-based distributions, CentOS}
    \cvitem{Other}{Agile/Scrum Methodologies}
\end{document}
