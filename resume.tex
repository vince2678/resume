...
\cventry{2022--Present}{Software Engineer}{}{TitanFile Inc}{}{
	\begin{itemize}
		...
		\item Worked with the Infrastructure Manager as part of the DevOps team to improve deployment process and migrate to using containerization/orchestration using Docker
