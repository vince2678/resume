...
\item Leveraged React Context API on the frontend to manage state between components, improving the scalability and maintainability of the application.
\item Collaborated with the DevOps team to migrate legacy systems to containerized environments using Docker.
\item Implemented Microsoft 365 integration using Python in the backend and TypeScript on the frontend, enabling seamless document editing.
