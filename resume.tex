...
\item Analyzed database queries causing crashes and improved them using SQL commands on the database back-end to optimize Django queries and reduce memory usage and downtime.
