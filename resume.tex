...
\cvitem{Tools}{Docker, Git, Node.js/Npm, Gerrit Code Review, GitLab, GNUMake, Ansible}%{}{}%{category 5}{XXX, YYY, ZZZ}
\cvitem{Frameworks and libraries}{Java Collections, Guice, Gson, Guava, Lombok, JUnit, Spring, React,js, Backbone.js, Underscore.js, Django, SQLAlchemy}%{}{}%{category 6}{XXX, YYY, ZZZ}
...
\cventry{2022}{Software Engineer}{}{TitanFile Inc}{}{
	\begin{itemize}
		\item Performed code reviews and participated in daily meetings as part of regular duties,
		\item Worked with senior developers as part of DevOps team to
		improve performance and security of tools/infrastructure used for
		development,
		\item Improved display of embedded images in emails sent via app's outlook plugin,
