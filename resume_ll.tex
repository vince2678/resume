...
\cvitem{Other}{Debian/RedHat-based systems, Android Build Systems, SE Linux, CloudFlare API}

\section{Experience}

\cventry{Apr 2022-- May 2025}{Full Stack Engineer}{TitanFile Inc}{Toronto}{}{
...
% \end{itemize}
  %\textbf{Responsibilities}
   \textbf{Accomplishments}
    %\newline
  \begin{itemize}
\item Migrated from Python3.8 to Python3.11 as DRI (Directly Responsible Individual) of Infrastructure, speeding up Django back-end execution by 20\%.
...
\cventry{2015--2020}{\href{https://github.com/Galaxy-MSM8916}{Android Custom ROMs}}{}{}{}{
   \begin{itemize}
        \item Deployed Jenkins/BuikdKite, to automate builds on code submission in Gerrit.
        \item Configured Debian-based executors to perform full Android builds via trigger from Jenkins/BuildKite.
        \item Wrote and maintained POSIX shell and Python scripts to perform full Android builds and upload artifacts to cloud storage and distribution.
        \item Implemented shims for older unsupported proprietary OEM libraries, ensuring device compatibility with new major Android releases.
        \item Analyzed system logs to debug builds and wrote SELinux policies to ensure devices are fully functional and secure by running trusted code, maintaining security on Android upgrades.
        \end{itemize}
    }
